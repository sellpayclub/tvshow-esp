  ...
  return (
    <section className="relative pt-12 pb-24 px-4 overflow-hidden">
      ...
      <div className="absolute top-4 right-4 z-50 flex gap-2">
        <div className="px-3 py-1 bg-white/10 rounded border border-white/20 text-white font-bold text-sm cursor-default">ES</div>
        <Link to="/pt" className="px-3 py-1 bg-white/5 rounded border border-white/10 text-gray-400 font-bold text-sm hover:text-white transition-colors">PT</Link>
      </div>
