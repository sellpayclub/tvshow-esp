...
const HeroPt: React.FC = () => {
    return (
        <section className="relative pt-12 pb-24 px-4 overflow-hidden">
            {/* Language Toggle */}
            <div className="absolute top-4 right-4 z-50 flex gap-2">
                <Link to="/" className="px-3 py-1 bg-white/5 rounded border border-white/10 text-gray-400 font-bold text-sm hover:text-white transition-colors">ES</Link>
                <div className="px-3 py-1 bg-white/10 rounded border border-white/20 text-white font-bold text-sm cursor-default">PT</div>
            </div>
            ...
            <div className="relative z-10 max-w-6xl mx-auto text-center">
                <div className="mb-10 space-y-6">
                    ...
                    <p className="text-lg md:text-2xl text-gray-100 max-w-3xl mx-auto font-light leading-relaxed">
                        Mais de <strong className="text-white">12.000 canais</strong> abertos e fechados, Netflix, Amazon Prime, Disney e muito mais.
                    </p>
                </div>
                ...
                <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-500 mb-12">
                    Direto na sua televisão ou CELULAR em um único sistema.
                </p>

                {/* Video Container - New PT video */}
                <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] mb-12 bg-black/50 backdrop-blur-sm relative">
                    ...
                    <VideoPlayer id="69ac164debb48f900ec58ec0" lazy={true} />
                </div>
                ...
                <div className="flex flex-col items-center gap-8">
                    <div className="flex items-center gap-3 px-6 py-3 bg-white/5 rounded-full border border-white/5 backdrop-blur-md">
                        ...
                        <span className="text-white font-medium">
                            <strong className="text-green-400">+ 100 mil</strong> clientes usam TV SHOW
                        </span>
                    </div>

                    <CTAButtonPt className="scale-110 shadow-2xl" />
                </div>
            </div>
        </section>
    );
