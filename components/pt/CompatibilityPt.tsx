...
const CompatibilityPt: React.FC = () => {
    const logos = [
    ...
    const features = [
        {
            ...
            color: "bg-purple-600",
            title: "Compatível com celulares",
            desc: "Instale o app TV Show no seu celular e aproveite filmes, séries e canais ao vivo onde quer que esteja.",
            sub: "Compatível com todos os modelos!"
        },
        {
            icon: <Monitor size={32} className="text-white" />,
            color: "bg-blue-600",
            title: "MÚLTIPLAS TELAS",
            desc: "Instale em todas as suas TVs ou compartilhe com amigos. Basta compartilhar o acesso e pronto! Todos vão aproveitar o melhor serviço com milhares de conteúdos disponíveis simultaneamente!"
        },
        {
            icon: <Settings size={32} className="text-white" />,
            color: "bg-green-600",
            title: "ESCOLHA A QUALIDADE",
            desc: "Todos os conteúdos incluem a opção de escolher a qualidade de imagem SD, HD, Full HD e 4K."
        },
        {
            icon: <DollarSign size={32} className="text-white" />,
            color: "bg-yellow-600",
            title: "PREÇO JUSTO",
            desc: "Nossos serviços são acessíveis para todos. Acesse milhares de conteúdos por um preço justo que cabe no seu bolso."
        },
        {
            icon: <MessageCircle size={32} className="text-white" />,
            color: "bg-pink-600",
            title: "SUPORTE TÉCNICO",
            desc: "Suporte disponível para você, diretamente no seu WhatsApp sempre que precisar."
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-24">
                    <h2 className="text-3xl md:text-4xl font-black text-white mb-12 uppercase tracking-tight">
                        COMPATÍVEL COM AS PRINCIPAIS MARCAS DE TV
                    </h2>
                    ...
                    <p className="text-sm md:text-base font-bold text-gray-400 uppercase tracking-widest animate-pulse">
                        E TODAS AS OUTRAS MARCAS DE TV COM APLICATIVOS!
                    </p>
                </div>
...
export default CompatibilityPt;
