    ...
    return (
        <footer className="bg-[#020202] border-t border-white/5 pt-20 pb-10 px-4 text-center">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mb-12">
                    <h4 className="font-bold text-white mb-6 uppercase text-xs tracking-widest">Formas de Pagamento</h4>
                    <div className="flex justify-center gap-3 transition-all duration-300">
                        <div className="h-8 bg-green-500/20 text-green-400 border border-green-500/30 rounded px-4 flex items-center text-xs font-bold tracking-widest">
                            SOMENTE PIX
                        </div>
                    </div>
                </div>
